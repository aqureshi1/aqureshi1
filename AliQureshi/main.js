...
// geo IP fill
$(".delivery-city").html(`Los Angeles 90069`);
...
$(".share-button").on("click", e => {
  ...
  if (navigator.share) {
    ...
    copyStringToClipboard("https://amazondating.co");
...
$(".add-to-cart, .buy-now").on("click", () => {
  ...
  document.title = "Checkout | Amazon Dating";
});
...
$(".place-order").on("click", () => {
  ...
  document.title = "Amazon Dating Thanks You";
});
;
